    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-xl shadow-2xl max-w-lg w-full max-h-[90vh] flex flex-col overflow-hidden">
        <div className="px-6 py-4 border-b border-gray-200 flex justify-between items-center bg-gray-50">
          <div>
            <h2 className="text-xl font-bold text-gray-900">Meal Plan Templates</h2>
            <p className="text-sm text-gray-500">Save and reuse your meal plans</p>
          </div>
          <button
            onClick={onClose}
            ...
            <form onSubmit={handleSave}>
              {!currentPlanHasRecipes ? (
                <div className="text-center py-8">
                  ...
                  <p className="text-gray-500 mb-2">No recipes in current plan</p>
                  <p className="text-sm text-gray-400">
